...
<body>
    ...
    <div class="col-9 col-s-9" id="tableRegistro">
        ...
        <form method="post" action="Crearprofesionalesservlet">
            <h2>Crear Profesional</h2>
            <table>
            	 <tr>

                    <td><label for="rutprof">RUT: </label></td>
                    <td><input type="text" name="rutprof" placeholder="...." /></td>
                </tr>

                <tr>

                    <td><label for="nombre">NOMBRE: </label></td>
                    <td><input type="text" name="nombre" placeholder="dd-mm-aaaa..." /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="titulo" placeholder="Escriba la duracion en minutos..." /></td>
                </tr>
                <tr>
                    <td><label for="proyecto">PROYECTO: </label></td>
                    <td><input type="text" name="proyecto" placeholder="Escriba su nombre..." /></td>
                </tr>

                <tr>
                    <td><input type="submit" value="Registrar Profesional" /></td>
