...
<body>
    ...
    <div class="col-9 col-s-9" id="tableRegistro">
        ...
        <form method="post" action="Crearadministrativoservlet">
            <h2>Crear Adimistrativo</h2>
            <table>
            	 <tr>

                    <td><label for="rut">RUT DEL ADMINISTRATIVO: </label></td>
                    <td><input type="text" name="rut" placeholder="...." /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="correo" placeholder="Escriba el lugar..." /></td>
                </tr>
                <tr>
